...
file1 = open('train.source', 'r')
file2 = open('train.target', 'r')
...
file1 = open('val.source', 'r')
file2 = open('val.target', 'r')
lines1 = file1.readlines()
...
# set decoding params                               
roberta_shared.config.max_length =256
...
#training and fitting all the train data
trainer.train()


tokenizer = RobertaTokenizerFast.from_pretrained("roberta-base")
model = EncoderDecoderModel.from_pretrained("./checkpoint-400")
